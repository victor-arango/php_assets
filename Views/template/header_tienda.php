	...
	<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
                        Bienvenido usuario: Victor Arango
                    </div>
                    <div class="right-top-bar flex-w h-full">
                    <a href="#" class="flex-c-m trans-04 p-lr-25 js-show-modal2">
							Ayuda 
						</a>
                    <a href="#" class="flex-c-m trans-04 p-lr-25 js-show-modal2">
							Mi Cuenta
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media()?>/tienda/images/LOGOALV.png" alt="Tienda Virtual">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media()?>/tienda/images/LOGOALV.png" alt="Tienda Virtual"></a>
			</div>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				...
				<li>
                    ...
                    <a href="#" class="flex-c-m p-lr-10 trans-04 js-show-modal2">
							Ayuda
						</a>
						<a href="#" class="flex-c-m p-lr-10 trans-04 js-show-modal2">
							Mi cuenta
